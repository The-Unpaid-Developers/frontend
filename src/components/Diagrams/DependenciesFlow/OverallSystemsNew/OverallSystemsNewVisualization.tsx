...
import OverallSystemsNewFilters from './OverallSystemsNewFilters';
import OverallSystemsNewDiagram from './OverallSystemsNewDiagram';
import OverallSystemsNewLegend from './OverallSystemsNewLegend';
...
const OverallSystemsNewVisualization: React.FC = () => {
  ...
  const handleNodeClick = (nodeId: string) => {
    ...
    // For example: navigate(`/system/${nodeId}`);
  };
