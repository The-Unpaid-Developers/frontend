...
const MIDDLEWARE_VALUES = ["NONE", "OSB", "API_GATEWAY"] as const; // IntegrationMethod.java
export const MIDDLEWARE = makeMap(MIDDLEWARE_VALUES);
export const MIDDLEWARE_OPTIONS = mapToOptions(MIDDLEWARE);
