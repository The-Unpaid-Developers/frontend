...
const SystemComponentStep: React.FC<StepProps> = ({
  ...
  const initialList: SystemComponent[] | null | undefined =
    ...
    <div className="space-y-4">
      ...
      <div className="grid md:grid-cols-3 gap-3 max-h-[380px] overflow-y-auto pr-1">
        ...
        <DropDown
          ...
          onChange={(e) =>
            updateLanguageFramework("language", "name", e.target.value)
          }
        ...
        <Input
          ...
          onChange={(e) =>
            updateLanguageFramework("language", "version", e.target.value)
          }
        />
        <DropDown
          label="Framework"
          ...
          placeholder="Select Framework"
          onChange={(e) =>
            updateLanguageFramework("framework", "name", e.target.value)
          }
          options={FRAMEWORK_OPTIONS}
        />
        <Input
          ...
          onChange={(e) =>
            updateLanguageFramework("framework", "version", e.target.value)
          }
        />
        ...
        <DropDown
          ...
          placeholder="Select Upgrade Frequency"
        ...
        />
        {row.latencyRequirement === 0 && (
          <Input
            type="number"
            placeholder="Latency"
            onChange={(e) =>
              update("latencyRequirement", Number(e.target.value))
            }
          />
        )}
        {row.latencyRequirement !== 0 && (
        ...
        {row.throughputRequirement === 0 && (
          <Input
            type="number"
            placeholder="Throughput"
            onChange={(e) =>
              update("throughputRequirement", Number(e.target.value))
            }
          />
        )}
        {row.throughputRequirement !== 0 && (
        ...
        {/* 0 is default value, so only show input box when it's 0 */}
        ...
        <Input
          ...
          onChange={(e) =>
            updateSecurityDetails("authenticationMethod", e.target.value)
          }
        />
        <Input
          placeholder="Authorization Model"
          value={row.securityDetails.authorizationModel}
          onChange={(e) =>
            updateSecurityDetails("authorizationModel", e.target.value)
          }
        />
        <label className="flex items-center gap-2 text-sm">
          <input
            ...
            onChange={(e) =>
              updateSecurityDetails("isAuditLoggingEnabled", e.target.checked)
            }
          />{" "}
          Audit Logging
        </label>
        <Input
          ...
          onChange={(e) =>
            updateSecurityDetails("sensitiveDataElements", e.target.value)
          }
        />
        <DropDown
          ...
          onChange={(e) =>
            updateSecurityDetails("dataEncryptionAtRest", e.target.value)
          }
          options={DATA_ENCRYPTION_AT_REST_OPTIONS}
        />
        <Input
          placeholder="Encryption Algorithm"
          value={row.securityDetails.encryptionAlgorithmForDataAtRest}
          onChange={(e) =>
        ...
        <label className="flex items-center gap-2 text-sm">
          <input
            ...
            onChange={(e) =>
              updateSecurityDetails("hasIpWhitelisting", e.target.checked)
            }
          />{" "}
          IP Whitelisting
        </label>
        ...
        />
        <Input
          placeholder="Payload Encryption Alg"
          value={row.securityDetails.payloadEncryptionAlgorithm}
          onChange={(e) =>
            updateSecurityDetails("payloadEncryptionAlgorithm", e.target.value)
          }
        />
        <Input
          placeholder="Digital Certificate"
          value={row.securityDetails.digitalCertificate}
          onChange={(e) =>
            updateSecurityDetails("digitalCertificate", e.target.value)
          }
        />
        <Input
          placeholder="Key Store"
          value={row.securityDetails.keyStore}
          onChange={(e) => updateSecurityDetails("keyStore", e.target.value)}
        />
        ...
        <DropDown
          label="Vulnerability Assessment Frequency"
          value={row.securityDetails.vulnerabilityAssessmentFrequency}
          placeholder="Select Vulnerability Assessment Frequency"
          onChange={(e) =>
            updateSecurityDetails(
              "vulnerabilityAssessmentFrequency",
              e.target.value
        ...
        <DropDown
          ...
          placeholder="Select Penetration Testing Frequency"
          onChange={(e) =>
            updateSecurityDetails("penetrationTestingFrequency", e.target.value)
          }
          options={FREQUENCY_OPTIONS}
        />
      </div>
            ...
            <tbody>
              {list.map((c, i) => (
                <tr key={i} className="border-t">
                  ...
                  <td className="p-2">
                    {c.languageFramework.language.name +
                      " - " +
                      c.languageFramework.language.version}
                  </td>
                  <td className="p-2">
                    {c.languageFramework.framework.name +
                      " - " +
                      c.languageFramework.framework.version}
                  </td>
                  ...
                  <td className="p-2">
                    {c.securityDetails.authenticationMethod}
                  </td>
                  <td className="p-2">
                    {c.securityDetails.authorizationModel}
                  </td>
                  <td className="p-2">
                    {c.securityDetails.isAuditLoggingEnabled ? "Yes" : "No"}
                  </td>
                  <td className="p-2">
                    {c.securityDetails.sensitiveDataElements}
                  </td>
                  <td className="p-2">
                    {c.securityDetails.dataEncryptionAtRest}
                  </td>
                  <td className="p-2">
                    {c.securityDetails.encryptionAlgorithmForDataAtRest}
                  </td>
                  <td className="p-2">
                    {c.securityDetails.hasIpWhitelisting ? "Yes" : "No"}
                  </td>
                  <td className="p-2">{c.securityDetails.ssl}</td>
                  <td className="p-2">
                    {c.securityDetails.payloadEncryptionAlgorithm}
                  </td>
                  <td className="p-2">
                    {c.securityDetails.digitalCertificate}
                  </td>
                  <td className="p-2">{c.securityDetails.keyStore}</td>
                  <td className="p-2">
                    {c.securityDetails.vulnerabilityAssessmentFrequency}
                  </td>
                  <td className="p-2">
                    {c.securityDetails.penetrationTestingFrequency}
                  </td>
                  <td className="p-2">
